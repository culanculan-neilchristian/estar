                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16">
                    ...
                    <div className="space-y-8">
                        ...
                        <ul className="space-y-4">
                            <li><Link href="/" className="text-sm text-white hover:text-white/80 transition-colors">Homepage</Link></li>
                            <li><Link href="/impact" className="text-sm text-white hover:text-white/80 transition-colors">Impact</Link></li>
                            <li><Link href="/movement" className="text-sm text-white hover:text-white/80 transition-colors">The Movement</Link></li>
                            <li><Link href="/stories" className="text-sm text-white hover:text-white/80 transition-colors">Stories</Link></li>
                        </ul>
                    </div>
