...
import { TimelineStateData } from './dummyProvinceData';

export const THAILAND_DUMMY_DATA: Record<number, TimelineStateData> = {
  0: {
    label: 'Initial Phase',
    date: '2024 JANUARY',
    churches: 150,
    ...
    bulletPoints: [
      "Covers all 77 provinces and Bangkok",
      "Goal to establish community centers"
    ],
    districts: [
    {
        "id": "0",
  ...
  1: {
    ...
    bulletPoints: [
      "Increased engagement in urban areas",
  ...
  2: {
    ...
    bulletPoints: [
      ...
      "Sustainable growth models implemented"
    ],
    districts: [
    {
        "id": "0",
